...
# Import dynamic ETL modules WITHOUT modifying them
from app.dynamic_etl.etl.extract.extractor import extract_data
from app.dynamic_etl.etl.transform_layer import run_transform_pipeline
